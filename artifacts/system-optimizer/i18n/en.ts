...
const en: AppTranslations = {
  ...
  agent: {
    title: "Nabd Autopilot",
    subtitle:
      "A local ReAct reasoning loop driving the device through native bridges and accessibility services.",
    inputLabel: "What should I optimize?",
    samplePrompt: "Optimize system performance for gaming",
    start: "Engage Autopilot",
    running: "Autopilot engaged…",
    timelineLabel: "ReAct execution timeline",
    complete: "COMPLETE",
    miniTerminalLabel: "Injected system commands",
    miniTerminalEmpty: "Waiting for command injection…",
  },
  terminal: {
  ...
  junkDeep: {
    ...
    nothingSelected: "Select items to clean",
    cleanedToast: "Freed {{size}} ({{count}} items)",
    cleanedNothing: "No files were deleted.",
    pendingNativeToast:
      "Skipped {{count}} item(s) that require the native module — they'll be wiped in the compiled build.",
    requiresNativeBadge: "Requires Native Module",
    categories: {
      cache: "App caches",
      temp: "Temp files",
      log: "Logs",
      other: "Other",
      obsoleteApk: "Obsolete APKs",
      emptyFolder: "Empty folders",
      systemDeep: "System Corpses & Deep Cache",
    },
  },
  optimizer: {
