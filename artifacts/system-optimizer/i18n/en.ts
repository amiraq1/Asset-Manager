...
const en: AppTranslations = {
  ...
  agent: {
    title: "Nabd Autonomous Agent",
    subtitle: "Give it a task; it'll reason and act on the device step by step.",
    inputLabel: "What do you want me to do?",
    samplePrompt: "Optimize system and launch PUBG",
    start: "Start Agent",
    running: "Running…",
    timelineLabel: "Reason & Act timeline",
    complete: "COMPLETE",
    miniTerminalLabel: "Live system commands",
    miniTerminalEmpty: "Waiting for commands…",
  },
  terminal: {
